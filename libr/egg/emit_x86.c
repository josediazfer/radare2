...
/*
   mov    $0x0,%r9d
   0x000000000040116e <+10>:    mov    $0x0,%r8d
   0x0000000000401174 <+16>:    mov    $0x4,%ecx
   0x0000000000401179 <+21>:    mov    $0x3,%edx
   0x000000000040117e <+26>:    mov    $0x2,%esi
   0x0000000000401183 <+31>:    mov    $0x1,%edi
